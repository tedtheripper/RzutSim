...
Events.on(engine, 'tick',function(){
  ...
  if(odw==0 && ball.velocity.y>=0 && ball.position.y >height-10-3*promien_pilki){
        var odp = "Final velocity : " + Math.sqrt(ball.velocity.y*ball.velocity.y+ball.velocity.x*ball.velocity.x).toFixed(2) + " m/s \n"
        var odp1 =  "Range : " + Math.abs(ball.position.x-poczatek).toFixed(2) + " m \n";
